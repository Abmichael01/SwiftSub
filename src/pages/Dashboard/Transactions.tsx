...
const statusColors: Record<string, string> = {
  Success: "text-green-500 bg-green-100 dark:text-foreground dark:bg-green-500",
  Pending: "text-yellow-500 bg-yellow-100 dark:text-foreground dark:bg-yellow-500",
  Failed: "text-red-500 bg-red-100 dark:text-foreground dark:bg-red-500",
};
